...
import { PriorityHistoryController as PriorityListHistoryController } from 'src/priority-list/modules/priority-list-history/priority-list-history.controller';
